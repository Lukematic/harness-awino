...
class TestRigorSkills(unittest.TestCase):
    def test_pins_load(self):
        ...
        names = st.names()
        self.assertEqual(len(names), 51)  # 29 + 14 osmani-* + definition-of-done + lifecycle-sequence + critical-thinking + completion-summary + incident-response + dora-metrics + debug + rpi
