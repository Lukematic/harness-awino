...
(function (root) {
  ...
  var PROVIDERS = [
    { id: "echo", label: "echo (safe default, no model)", needsKey: false,
    ...
    { id: "openai", label: "openai-compatible (endpoint + AWINO_API_KEY)", needsKey: true,
      docsUrl: "https://platform.openai.com/docs",
      keyUrl: "https://platform.openai.com/api-keys", keyName: "OpenAI" },
    { id: "anthropic", label: "anthropic (ANTHROPIC_API_KEY)", needsKey: true,
